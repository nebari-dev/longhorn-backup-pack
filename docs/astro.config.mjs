...
// Deploy conventions, set by .github/workflows/docs.yml (PACK_SLUG: longhorn-backup-pack):
//
//   main    SITE=https://packs.nebari.dev              BASE=/longhorn-backup-pack/
//   preview SITE=https://<branch>.longhorn-backup-pack.pages.dev  BASE=/
//
  ...
  integrations: [
    starlight({
      ...
      editLink: {
        ...
        baseUrl: 'https://github.com/nebari-dev/longhorn-backup-pack/edit/main/docs/',
      },
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'Backup target', link: '/backup-target/' },
            { label: 'Coverage model', link: '/coverage/' },
          ],
        },
        {
          label: 'Guides',
          items: [
            { label: 'Restoring a volume', link: '/restore/' },
            { label: 'Disaster recovery', link: '/disaster-recovery/' },
